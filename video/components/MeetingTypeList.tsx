...
const MeetingTypeList = () => {
  ...
  return (
   ...
   {!callDetails ? (
        ...
        >
         <div>
            <label className="flex w-full flex-col gap-2.5 text-white">
            Add a Description
            </label>
            <Textarea className="border-none bg-dark-3 focus-visible:ring-0 focus-visible:ring-offset-0 text-white "
